...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>VIDA Spa - Promotions</title>
...
<main class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-5">
        <img class="img-fluid" src="assets/img/facial.jpg" alt="">
    </div>
  </div>
  <hr class="m-5">
  <div class="row text-center">
  <h2>90 minutes Dermalogica Treatment</h2>
  <h1 class="text-danger"><small class="text-body-secondary fw-light text-decoration-line-through">$1,000</small> $900</h1>
  <h5>30 mins back and 60 mins facial</h5>
  <p>This treatment is design to ensure nourishment and moisture level for healthy hydrated looking skin featuring Dermalogica product.</p>
  </div>
