  ...
  ?>
    ...
    <h6 class="text-center mb-3 mt-5">Add New User</h6>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button class="btn btn-success" type="submit" disabled>SAVE <span data-feather="upload-cloud" class="align-text-end"></button>
        </div>
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-sm p-0 m-0" data-bs-toggle="modal" data-bs-target="#exampleModal" disabled>
                    <span>
