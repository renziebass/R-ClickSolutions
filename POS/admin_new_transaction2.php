...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  if(!empty($_GET["product_id2"]) && !empty($_GET["quantity2"])) {
      ...
      header("refresh:0.1;url=admin_new_transaction2.php?id=".$_GET['id']."&date=".$_GET['date']."");
...
if(!empty($_GET['payment'])){
      ...
      if(empty($resultCheck2))  {
        ...
        header( "refresh:0.5;url=admin_new_transaction2.php?date=".$_GET['date']."" );
        ...
        <div class="card-body">
          <div class="float-end">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
              ...
              <h6 class="text-muted fw-normal px-5" title="Number of Customers">Items</h6>
              <h3 class="px-5">
                <?php
                if(empty($row2['items'])) {
                $items ="0";
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                ...
                <?php echo $disc_msg; ?>
                  <span>
                    ...
                    onclick="location.href='admin_new_transaction2.php?id=<?php echo $_GET['id'];?>&date=<?php echo  $_GET['date']?>'"> 
...
<form>
  ...
  <div class="btn-group-vertical">
    <button type="button" class="btn btn-secondary btn-sm" style="--bs-btn-padding-y: .15rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" accesskey="z" onclick="location.href='admin_dashboard.php'">ALT+Z</button>
    <button type="button" class="btn btn-sm btn-outline-secondary fw-bold" accesskey="z" onclick="location.href='admin_dashboard.php'">HOME</button>
  </div>
  <div class="btn-group-vertical">
    <button type="button" class="btn btn-success btn-sm" style="--bs-btn-padding-y: .15rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" accesskey="c" onclick="window.open('admin_new_transaction2.php?id=<?php echo $TR;?>&date=<?php echo date('Y-m-d')?>')" <?php echo $button;?>>ALT+C</button>
    <button type="button" class="btn btn-sm btn-outline-success fw-bold" accesskey="c" onclick="window.open('admin_new_transaction2.php?id=<?php echo $TR;?>&date=<?php echo date('Y-m-d')?>')" <?php echo $button;?>>NEW TR</button>
  </div>
  <div class="btn-group-vertical">
    <button type="button" class="btn btn-danger btn-sm" style="--bs-btn-padding-y: .15rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" accesskey="v" onclick="window.open('admin_unpaid_transactions.php')"  <?php echo $button;?>>ALT+V</button>
    <button type="button" class="btn btn-sm btn-outline-danger fw-bold" accesskey="v" onclick="window.open('admin_unpaid_transactions.php')"  <?php echo $button;?>>UNPAID</button>
  </div>
</form>
</div>
