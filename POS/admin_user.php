...
<div class="container-fluid">
  ...
  ?>
    ...
    <div class="d-flex justify-content-end mt-3 mb-3">
          ...
          <div class="col border rounded shadow m-1">
            <div class="card-body p-2">
              <div class="float-end">
                ...
                <h6 class="text-muted fw-normal mt-0"><?php echo $row1['acc_type'];?></h6>
                <h3 class=""><?php echo $row1['userid'];?> - <?php echo $row1['name'];?></h3>
                <p class="mb-0 text-muted">
                <span class="text-primary fw-bold"><?php echo $row1['phone'];?></span>
                <span class="text-nowrap me-2">Phone</span>
                </p>
            </div>
          </div>
      ...
      <h6 class="mt-3 text-muted text-center">Login History</h6>
