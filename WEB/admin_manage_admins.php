...
if(!empty($_GET['xid'])) {
  $sql7="DELETE FROM tb_admins WHERE tb_admins.userid='" .$_GET['xid']. "'";
...
<html lang="en">
  ...
  <script type="text/javascript">
    ...
    <div class="mx-5">
      ...
      <div class="col">
      <h5 class="text-center pt-3" id="text1">ADD ADMIN</h5>
          <div class="col px-5">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-3">
                  <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="first_name" placeholder="First Name">
                </div>
                <div class="form-group col-md-3">
                  <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="middle_name" placeholder="Middle Name">
                </div>
                <div class="form-group col-md-3">
                  <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="last_name" placeholder="Last Name">
                </div>
      ...
      <table class=" col-md-6 mx-auto table table-hover" id="saleshistorydiv">
                <thead >
                <h5 class="text-center" id="text1">ALL ADMINS</h5>
                ...
                <?php
                  $sql="SELECT
                  tb_admins.userid,
                  CONCAT(tb_admins.first_name,' ',tb_admins.middle_name,' ',tb_admins.last_name)AS name,
                  tb_admins.phone
                   FROM `tb_admins`";
                ...
                ?>
                      <tr>  
                        ...
                        <td><button onclick="location.href='admin_manage_admins.php?xid=<?php echo $items['userid'];?>'" type="button" class="close text-danger" aria-label="Close">
