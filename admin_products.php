        ...
        <div class="card shadow border-start-primary" style="height:700px;">
            ...
            <div class="container text-center">
                <div class="row align-items-start">
                    <div class="col-3 d-flex flex-row">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu overflow-y-scroll" style="height: 600px;">
                              <?php while($row1 = mysqli_fetch_array($result1)):;?>
                                <a class="dropdown-item" href="admin_products.php?pcategory=<?php echo $row1['category'];?>" value="<?php echo $row1['category'];?>">
                    ...
                    <div class="btn">
                        <button class="btn btn-secondary btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                    ...
                    <div class="col-3 d-flex flex-row-reverse">
                      <button type="button" onclick="printDiv();" class="btn btn-secondary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
                ...
                ?>
                                <div class="row">
                                    <div class="col">
                                    <a class="link-offset-2 link-underline link-underline-opacity-0" onclick="location.href='admin_product.php?id=<?php echo $items['id'];?>'"><?php echo $items['id'];?></a>
                                    </div>
                                    <div class="col">
