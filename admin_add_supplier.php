        ...
        <table class="table table-hover table-sm">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  <svg onclick="location.href='admin_add_supplier.php?xid=<?php echo $items['id'];?>'" class="text-danger" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square-fill" viewBox="0 0 16 16">
