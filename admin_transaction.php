...
if((empty($_GET['id']))) {
  header("Location: admin_paid.php?date=".date("Y-m-d")."");
        ...
        <div class="col-md-11 input-group mb-5 mx-auto d-flex flex-row-reverse">
            <div class="input-group-prepend"> 
                <div class="input-group-append" id="button-addon4">
                  <button class="btn btn-outline-danger" type="button" onclick="location.href='admin_transaction.php?VoidID=<?php echo $_GET['id']?>'" <?php echo $voidButton; ?>><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
