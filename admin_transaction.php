...
<html lang="en">
  <head>
    ...
    <title>TR ID : <?php echo $_GET['id']; ?></title>
            ...
            <div class="container text-center">
                <div class="row align-items-start">
                    <div class="col-6 d-flex flex-row">
                        <div class="btn-group">
                        <button type="button" onclick="location.href='admin_transaction.php?VoidID=<?php echo $_GET['id']?>'" class="btn btn-danger btn-sm" <?php echo $voidButton; ?>><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
