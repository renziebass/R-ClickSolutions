                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>SALES TODAY (<?php echo date("M d Y")?>)</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo $row1['paid'];?></span></div>
                                        </div>
                            ...
                            <div class="card shadow mb-4" style="height: 165px;">
                                ...
                                <?php
                                  ...
                                  ?>
                                    ...
                                    <thead>
                                    <h5 class="text-center mt-0 mb-0">Low on Stocks</h5>
                                      <tr>
                                        <th scope="col">Product ID</th>
                                        <th scope="col">Brand</th>
                                        <th scope="col">Specification</th>
